...
describe('Member', function () {
    ...
    describe('middleware', function () {
        it('Should add single middleware', function () {
            ...
            expect((member._middleware as IMiddleware[])[0]).toBe(middleware);
        });
        it('Should add multiple middleware', function () {
            ...
            expect((member._middleware as IMiddleware[])[0]).toBe(middleware1);
            expect((member._middleware as IMiddleware[])[1]).toBe(middleware2);
        });
        it('Should return itself', function () {
            const member = new (Member as any)('');
